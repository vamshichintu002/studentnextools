  ...
  return (
    <button
      className={cn(
        ...
        // after styles (shine effect)
        "after:absolute after:inset-0 after:z-10 after:animate-shine after:bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.2),transparent)] after:bg-[length:200%] after:opacity-0 hover:after:opacity-100",
